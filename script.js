...
var Game = {
  ...
  endGameMenu: function (text) {
    ...
    Pong.context.fillText(
      ...
      Pong.canvas.width / 2,
      Pong.canvas.height / 2 + 70
    );

    // Attach a click event listener to the canvas to restart the game when clicked
    Pong.canvas.addEventListener("click", function restartGame() {
      Pong.canvas.removeEventListener("click", restartGame); // Remove the click event listener to prevent multiple event bindings
